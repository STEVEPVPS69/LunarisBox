...
local scriptUrl = "https://raw.githubusercontent.com/STEVEPVPS69/LunarisBox/main/script.lua"
...
if success then
    ...
    if whitelist[tostring(player.UserId)] then
        -- Load and execute the original script
        local originalScript = HttpService:GetAsync(scriptUrl)
